...
public class StatistikPane extends GridPane {
	...
	private ComboBox<Laegemiddel> lstLægemidler = new ComboBox<>();
	...
	public void updateDetails() {
		try {
			String vægt1 = txfVægtFra.getText();
			String vægt2 = txfVægtTil.getText();
			
			int vægtFra = Integer.parseInt(vægt1);
			int vægtTil = Integer.parseInt(vægt2);
...
//			int vTil = Integer.valueOf(txfVægtTil.getText());
			...
			int antal = controller.antalOrdinationerPrVægtPrLægemiddel(vægtFra, vægtTil, lægemiddel);
