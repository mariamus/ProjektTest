...
public class Controller {
	...
	public PN opretPNOrdination(LocalDate startDen, LocalDate slutDen, Patient patient, Laegemiddel laegemiddel,
		...
		if (startDen.isBefore(slutDen) || startDen.isEqual(slutDen)) {
			...
			throw new IllegalArgumentException("Startdato må ikke være efter slut dato");
		}
	}
	...
	public DagligFast opretDagligFastOrdination(LocalDate startDen, LocalDate slutDen, Patient patient,
		...
		Pre.require(startDen != null || slutDen != null || patient != null || laegemiddel != null);
		if (startDen.isBefore(slutDen) || startDen.isEqual(slutDen)) {
			DagligFast dagligFast = new DagligFast(morgenAntal, middagAntal, aftenAntal, natAntal, startDen, slutDen);
	...
	public void ordinationPNAnvendt(PN ordination, LocalDate dato) {
		Pre.require(ordination != null || dato != null);
	...
	public double anbefaletDosisPrDoegn(Patient patient, Laegemiddel laegemiddel) {
		double result;
		Pre.require(patient != null || laegemiddel != null);
	...
	public int antalOrdinationerPrVægtPrLægemiddel(double vægtStart, double vægtSlut, Laegemiddel laegemiddel) { 
		int antal = 0; 
		Pre.require(laegemiddel != null); 
		if (vægtSlut > vægtStart) { 
			double temp = vægtSlut; 
			vægtSlut = vægtStart; 
			vægtStart = temp; 
		} 
